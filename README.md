<!--
File: README.md
Document Title: Aurora Cosmos — Static Portfolio Theme
...
# Aurora Cosmos — Static Portfolio Theme
...
**Aurora Cosmos** is a distinctive static portfolio theme with an exploratory interface inspired by technical systems, cosmic imagery, and futuristic control panels.
...
The visual direction draws from mission-control systems, observatory interfaces, cosmic dashboards, telemetry displays, and futuristic technical environments. The theme should retain its exploratory atmosphere while keeping portfolio content readable and organized.
...
| Color | Primary Use |
| --- | --- |
| `#5EEAD4` | Used throughout the theme styling |
| `#FFF` | Used throughout the theme styling |
| `#14B8A6` | Used throughout the theme styling |
| `#8B5CF6` | Used throughout the theme styling |
| `#020617` | Used throughout the theme styling |
| `#9CA3AF` | Used throughout the theme styling |
| `#34D399` | Used throughout the theme styling |
| `#E5E7EB` | Used throughout the theme styling |
| `#F8FAFC` | Used throughout the theme styling |
| `#EC4899` | Used throughout the theme styling |
...
| Component | Purpose |
| --- | --- |
| `components/AuroraBackground.js` | Provides reusable theme interface behavior |
| `components/Layout.js` | Provides shared layout and page framing |
| `components/Navigation.js` | Provides shared navigation behavior |
| `components/Starfield.js` | Provides reusable theme interface behavior |
...
- `components/AuroraBackground.js` supports the shared interface presentation.
- `components/Layout.js` supports the shared interface presentation.
- `components/Navigation.js` supports the shared interface presentation.
- `components/Starfield.js` supports the shared interface presentation.
...
├── images/
│   └── screenshots/
│       └── aurora-cosmos-preview-placeholder.svg
├── .nojekyll
├── about.html
├── articles.html
├── casestudies.html
...
```text
https://apursley2012.github.io/aurora-cosmos/
```
...
[Report an issue or request an addition](https://github.com/apursley2012/aurora-cosmos/issues/new/choose)
...
- Live GitHub Pages demo: `https://apursley2012.github.io/aurora-cosmos/`
